...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filesList = __webpack_require__(69);
	...
	function main(_ref) {
	    ...
	    var searchForm = (0, _searchForm2.default)({ DOM: DOM });
	    var fileList = (0, _filesList2.default)({ DOM: DOM, HTTP: HTTP, props: { name$: searchForm.value$ } });

	    var vtree$ = _rx.Observable.combineLatest(fileList.DOM, searchForm.DOM, function (FilesList, SearchForm) {
	        return (0, _dom.hJSX)(
	            'div',
	            null,
	            SearchForm,
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx hJSX */
	function intent(DOM) {
	    var submitForm$ = DOM.select('#repo').events('submit').do(function (ev) {
	        return ev.preventDefault();
	    });

	    var input$ = DOM.select('.repo-name').events('input').map(function (ev) {
	        return ev.target.value;
	    });

	    return { submitForm$: submitForm$, input$: input$ };
	}
	/*eslint-disable no-unused-vars*/

	function model(actions) {
	    return actions.submitForm$.withLatestFrom(actions.input$, function (sf$, name) {
	        return name;
	    });
	}

	function view() {
	    return _rx.Observable.of((0, _dom.hJSX)(
	        'form',
	        { id: 'repo', className: 'form-inline' },
	        (0, _dom.hJSX)(
	            'div',
	            ...
	            (0, _dom.hJSX)('input', { type: 'text', name: 'repo-name', className: 'form-control repo-name' })
	        ),
	        (0, _dom.hJSX)('input', { type: 'submit', className: 'btn btn-default', value: 'Get repo filesystem!' })
	    ));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function intent(DOM, HTTP) {
	    var dirClick$ = DOM.select('.enter-dir').events('click').do(function (ev) {
	        return ev.preventDefault();
	    }).map(function (ev) {
	    ...
	    return { dirClick$: dirClick$, response$: response$ };
	}
	/*eslint-enable no-unused-vars*/
	/** @jsx hJSX */

	function model(actions) {
	    var response$ = actions.response$.flatMap(function (rawResponse$) {
	        return rawResponse$.catch(function () {
	...
	function view(state$, navigationDOM) {
	    var vtree$ = state$.withLatestFrom(navigationDOM, function (files, Path) {
	                        ...
	                        dir.files.map(function (file) {
	                            return (0, _dom.hJSX)(
	                                ...
	                                (0, _dom.hJSX)(
	                                    'td',
	                                    null,
	                                    file.type === 'dir' ? (0, _dom.hJSX)(
	                                        'a',
	                                        { className: 'enter-dir', href: '#' },
	                                        file.name
	                                    ) : file.name
	                                ),
	                                (0, _dom.hJSX)('td', { className: 'text-right' })
	                            );
	                        })
	                    )
	                )
	...
	function http(props) {
	    var GITHUB_SEARCH_API = 'https://api.github.com/repos/';

	    var base$ = props.name$.map(function (name) {
	        return '' + GITHUB_SEARCH_API + name + '/contents';
	    });

	    var url$ = props.path$.withLatestFrom(base$, function (path, url) {
	        return '' + url + path;
	    });
	...
	function FilesList(_ref) {
	    ...
	    var navigation = (0, _navigation2.default)({
	        DOM: DOM,
	        props: { dirClick$: _rx.Observable.merge(actions.dirClick$, props.name$.map(function () {
	                return null;
	            })) }
	    });
	    var request$ = http({ path$: navigation.path$, name$: props.name$ });

	    var state = model(actions, props);
	    var vtree$ = view(state.response$, navigation.DOM);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx hJSX */
	function intent(DOM) {
	    var backClick$ = DOM.select('.go-back').events('click').do(function (ev) {
	        return ev.preventDefault();
	    });

	    return { backClick$: backClick$ };
	}
	/*eslint-disable no-unused-vars*/
	...
	function model(actions, props) {
	    ...
	    var state$ = _rx.Observable.merge(props.dirClick$, actions.backClick$.map(function () {
	        return BACK_SIGNAL;
	    })).scan(function (p, c) {
	        ...
	        return path.replace('//', ROOT_REPO_PATH);
	...
	function view(state$) {
	    var vtree$ = state$.map(function (path) {
	        return (0, _dom.hJSX)(
	            'div',
	            null,
	            (0, _dom.hJSX)(
	            ...
	            (0, _dom.hJSX)(
	                ...
	                (0, _dom.hJSX)(
	                    ...
	                    (0, _dom.hJSX)(
	                        ...
	                        path.length > 1 ? (0, _dom.hJSX)(
	                            'button',
	                            { className: 'btn btn-default btn-xs go-back' },
	                            'Go Back'
	                        ) : ''
	                    )
	                )
